#As of March 1st, 2019, all of these functions have been disabled in order to *hopefully*
#Avoid the bug that is occuring. No where in my code is capital letters. Therefore,
#I have to assume it is something within these functions. 
